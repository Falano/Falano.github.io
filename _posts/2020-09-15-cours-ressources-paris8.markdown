...
- strategy (cf wesnoth) <details> ![wesnoth](/assets/508_wesnoth.jpg)
    - grid?
    - team colors?
    - available moves?
    - cone of visibility (stealth games) and radius of sound?
...
des ralentis!
Night In The Woods jump on stuff
is it fun? make more of it. is it not? Remove it.
