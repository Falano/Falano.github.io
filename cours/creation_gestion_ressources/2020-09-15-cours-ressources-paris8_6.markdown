...
permalink: /cours/creation_gestion_ressources/finitions.html
...
- UI cohérent avec l'univers graphique
    - figuratif
        ...
        - futur: néons, hologrammes, effet écran (glitches, lignes cathodiques), semi-transparence (cf Transistor, cf Starcraft II)<details> - ![Age of Empires](/assets/cours/702_aoe2.jpg) <br> - ![moonlighter](/assets/cours/703_moonlighter.jpg) <br> - ![Night in the woods](/assets/cours/704_nitw.jpg) <br> - ![Transistor](/assets/cours/705_transistor.jpg) <br> - ![Starcraft II](/assets/cours/706_sc2.jpg)
    - abstrait (cf sims)
        - minimaliste (cf overland, mini metro, a short hike)
        - cartoon
        - motifs
        - style graphique non-figuratif précis (cf persona 5) <details> - ![les sims 4](/assets/cours/707_sims.jpg) <br> - ![overland](/assets/cours/708_overland.jpg) <br> - ![minimetro](/assets/cours/997_minimetro.jpg) <br> - ![a short hike](/assets/cours/708b_aShortHike.jpg) <br> - ![persona 5](/assets/cours/709_persona5.jpg)
    - ou un mélange des deux (cf crusader kings 2)
        - motifs abstraits sur un fond qui évoque du parchemin (cf pyre) <details> - ![crusader kings 2](/assets/cours/710_crusaderKings2.jpg) <br> - ![pyre](/assets/cours/711_pyre.jpg)
- strategie (cf wesnoth) <details> ![wesnoth](/assets/cours/508_wesnoth.jpg)
    - grille?
    - couleurs des équipes?
    - déplacements disponibles?
    - cône de visibilité (jeux furtifs) et radius du son?
- astuce pour créer du volume rapidement sur un élément de UI (cf minecraft) <details> ![minecraft](/assets/cours/712_minecraft.jpg)
...
- comparaison ff7 vieux/remake (plus petits écrans) <details> ![ff7](/assets/cours/713_ff7.jpg)
...
- diégétique / extradiégétique (cf metroid prime, spelunky, dead space) <details> - ![Metroid Prime](/assets/cours/714_metroidPrime.jpg) <br> - ![Spelunky](/assets/cours/715_spelunky.jpg) <br> - ![Dead Space](/assets/cours/716_deadSpace.jpg)
- pas de UI (cf alto's adventure, journey) <details> - ![alto's adventure](/assets/cours/718_altosAdventure.jpg) <br> - ![journey](/assets/cours/717_journey.jpg)
...
- Jan (Vlambeer), conférence "the art of screenshake" (vidéo): <https://www.youtube.com/watch?v=AJdEqssNZ-U>
    ...
    - flux d'informations <details> ![flux d'informations](/assets/cours/791_jansTalk.jpg)
